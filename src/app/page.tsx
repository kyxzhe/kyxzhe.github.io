        ...
        <section className="w-full max-w-[48rem] flex flex-col items-center gap-4 mt-2">
          ...
          >
            ...
            <div className="flex items-end gap-3">
              ...
              <button
                type="button"
                className={`inline-flex h-10 w-10 items-center justify-center rounded-full transition disabled:opacity-60 disabled:cursor-not-allowed -mr-0.5 ${prompt.trim() ? "bg-foreground text-white dark:bg-white dark:text-[#0b0b0d]" : "bg-[rgba(0,0,0,0.05)] text-muted-foreground dark:bg-white/15 dark:text-white"}`}
