  ...
  const renderGrid = () => {
    ...
    return (
      ...
      <div className="grid gap-6 lg:grid-cols-12 items-start">
        {heroItem && (
          <motion.article
            className="surface-card flex flex-col gap-0 overflow-hidden rounded-[24px] lg:col-span-8 lg:sticky lg:top-12"
            whileHover={{ y: -6, boxShadow: "0 28px 55px rgba(0,0,0,0.18)" }}
            transition={{ duration: 0.25, ease: [0.4, 0, 0.2, 1] }}
          >
            <div className="relative w-full aspect-[5/3] min-h-[320px] md:min-h-[420px] lg:min-h-[520px] rounded-[24px] overflow-hidden">
              <Image
                src={heroItem.cover}
                alt={heroItem.title}
                fill
            ...
            <div className="relative -mt-14 md:-mt-16 lg:-mt-20 px-5 pb-6 pt-16 md:pt-20 lg:pt-24 bg-background/95 dark:bg-background/80 backdrop-blur-sm flex flex-col gap-3 rounded-[24px]">
