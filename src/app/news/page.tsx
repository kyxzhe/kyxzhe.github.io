    ...
    <div className="min-h-screen bg-[#f7f7f8] text-foreground">
      ...
      >
        <section className="mt-4 space-y-2">
          <p className="text-[10px] uppercase tracking-[0.32em] text-muted-foreground">Newsroom</p>
          <h1 className="text-[2.35rem] md:text-[2.55rem] font-semibold leading-tight text-foreground">Latest news &amp; updates</h1>
          <p className="text-[16px] md:text-[17px] text-muted-foreground max-w-2xl leading-relaxed">
