  ...
  const renderGrid = () => {
    ...
    return (
      ...
      <div className="grid gap-6 lg:grid-cols-12 items-start">
        {heroItem && (
          <motion.article
            className="surface-card relative overflow-hidden rounded-[24px] aspect-[4/3] sm:aspect-[3/2] lg:aspect-[7/4] min-h-[320px] md:min-h-[420px] lg:min-h-[520px] lg:col-span-8 lg:sticky lg:top-12"
          ...
          >
            ...
            />
            <div className="absolute inset-x-0 bottom-0 bg-background/95 dark:bg-background/80 backdrop-blur-sm px-6 pb-6 pt-8 flex flex-col gap-3">
