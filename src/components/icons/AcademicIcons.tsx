...
export function GoogleScholarIconColor(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true" focusable="false" {...props}>
      <path d="M32 6 6 22l26 14 26-14L32 6Z" fill="#4285F4" />
      <path d="M6 24v18.5c0 2 1.1 3.8 2.8 4.7L28 57.5V36L6 24Z" fill="#34A853" />
      <path d="M58 24 36 36v21.5l19.2-10.3c1.7-.9 2.8-2.7 2.8-4.7V24Z" fill="#FBBC04" />
