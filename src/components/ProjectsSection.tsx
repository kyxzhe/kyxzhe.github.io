...
export default function ProjectsSection() {
  ...
  return (
    <div id="projects" className="flex flex-col w-full lg:w-[30%] gap-4 md:justify-between lg:mb-6 overflow-visible">
      ...
      <Link href="/news" className="flex-grow" aria-label="Explore Lab News">
        <motion.div 
          className="surface-card text-foreground p-4 md:p-6 flex-grow md:flex-wrap flex flex-col min-h-[420px] md:min-h-0 h-full"
